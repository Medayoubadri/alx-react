...
describe("Notifications", () => {
  ...
  describe("shouldComponentUpdate functionality", () => {
    it("does not re-render when listNotifications is updated with the same list", () => {
      const wrapper = shallow(
        <Notifications
          displayDrawer={true}
          listNotifications={listNotifications}
    ...
    it("re-renders when listNotifications is updated with a longer list", () => {
      const wrapper = shallow(
        <Notifications
          displayDrawer={true}
          listNotifications={listNotifications}
    ...
    it("re-renders when displayDrawer prop changes", () => {
      const wrapper = shallow(
        <Notifications
          displayDrawer={false}
          listNotifications={listNotifications}
