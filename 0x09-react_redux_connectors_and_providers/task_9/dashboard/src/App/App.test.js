...
describe("App tests", () => {
  ...
  it("should render NotificationsContainer component", () => {
    expect(wrapper.find("Connect(NotificationsContainer)").exists()).toEqual(
      true
    );
  });
  ...
  it("renders courselist if logged in", () => {
    ...
    expect(courseListSection.find("Connect(CourseList)").exists()).toBe(true);
